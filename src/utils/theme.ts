...
export const NICHES: Record<NicheType, NicheConfig> = {
  vendas: {
    ...
    defaultSpecialty: 'Representação comercial, vendas B2B/B2C, produtos e pedidos',
    projectSectionTitle: 'Catálogo de Produtos, Pedidos & Vendas',
    projectSectionSubtitle: 'Controle de vendas realizadas, catálogo de produtos, pedidos em rota e comissões.',
    categories: [
  ...
  arquitetura: {
    ...
    iconName: 'Compass',
    defaultTitle: 'Arquitetura e Interiores',
    defaultSpecialty: 'Especialista em projetos residenciais, comerciais e interiores',
    projectSectionTitle: 'Projetos & Portfólio de Arquitetura',
    projectSectionSubtitle: 'Projetos desenvolvidos, renders 3D, especificações e evolução de obras.',
    categories: [
  ...
  imobiliario: {
    ...
    projectSectionTitle: 'Imóveis, Captações & Negociações',
    projectSectionSubtitle: 'Imóveis anunciados, contratos de locação, captações exclusivas e comissões.',
    categories: [
  ...
  fotografia: {
    ...
    projectSectionTitle: 'Ensaios, Eventos & Produções',
    ...
    categories: [
      ...
      { id: 'arquitetura', label: 'Espaços & Arquitetura' },
  ...
  tecnologia: {
    ...
    statusOptions: [
      { value: 'estudo_preliminar', label: 'Descoberta & Arquitetura' },
  ...
  eventos: {
    ...
    projectSectionTitle: 'Eventos, Cronogramas & Fornecedores',
    projectSectionSubtitle: 'Planejamento de datas, contratação de fornecedores, roteiros e execução do evento.',
    categories: [
  ...
  outro: {
    ...
    iconName: 'Layers',
    defaultTitle: 'Meu Escritório / Studio Profissional',
    defaultSpecialty: 'Projetos, atendimentos, vendas e serviços especializados',
    projectSectionTitle: 'Meus Projetos & Portfólio',
    projectSectionSubtitle: 'Organize suas entregas, contratos, finanças e fotos em um único painel.',
    categories: [
      { id: 'all', label: 'Todos os Projetos' },
